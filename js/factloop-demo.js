...
(function () {
  ...
  var DICT = {
    ...
    "zh-Hans": {
      "fl.meta.title": "FactLoop Newsroom｜Miloop AI",
      "fl.meta.description": "一套多 Agent 新闻编辑室，把任何语言的关键字变成经过查证、有来源可循的报道，查不出来的就不发。欢迎实际试跑。",
      "fl.back": "返回首页",
      "fl.hero.eyebrow": "作品案例",
      "fl.hero.title.pre": "一个会",
      "fl.hero.title.em": "自我查证",
      "fl.hero.title.post": "的新闻编辑室。",
      "fl.hero.lede": "FactLoop Newsroom 接受任何语言的主题，回传一篇用同样语言写成的报道，内容只来自它能指给您看的来源。如果它没办法查证自己刚写下的东西，它就什么都不发。这一页往下拉，您可以自己跑一次。",
      "fl.spec.role": "角色",
      ...
      "fl.problem.title": "AI 写得快，但那从来不是难的部分。",
      "fl.problem.body": "把一个新闻主题丢给语言模型，几秒钟内就会拿到一篇干净利落的稿子。其中有些是真的，其余的读起来一模一样。对于赶截止时间的人来说，这不是省下时间，而是把风险转嫁给最后读到的那个人。所以真正值得解决的问题，不是怎么让 AI 写得更快，而是怎么在东西发出去之前，就知道哪几句话真的有依据。",
      "fl.how.eyebrow": "运作方式",
      ...
      "fl.stage5.name": "发布",
      "fl.stage5.body": "把成稿整理成搜索引擎和 AI 助理读得懂的形式，过程中不新增任何内容。",
      "fl.stage.retry": "撰稿阶段有两次机会，修正查证挑出来的问题。如果第三版仍然站不住脚，整次运行就此打住，什么都不发布。您在下面的演示 里很可能会遇到这种情况。",
      "fl.principle.eyebrow": "设计取舍",
      "fl.principle.title": "三个决定了成败的选择。",
      "fl.principle1.title": "搜集事实的那一步，刻意不放 AI",
      ...
      "fl.demo.note": "这个演示 每次执行都会实际搜索新闻，并调用好几个 AI 模型，因此有使用次数限制。请试个两三个主题就好，不必一口气试十几个。",
      "fl.demo.submit": "开始执行",
      "fl.demo.running": "执行中…",
      "fl.demo.loading.start": "正在启动。",
      "fl.demo.loading.waking": "这个演示 的服务器闲置时会休眠，唤醒大约需要一分钟，所以当天第一次执行会特别慢。这不是出错。",
      ...
      "fl.demo.limit.body": "这个演示 有次数限制，用来控制实际的运行成本。请稍后再试。",
      "fl.demo.error.title": "出了点问题。",
      "fl.demo.error.body": "这次执行没有完成。请稍后再试一次；如果一直这样，欢迎发邮件到 info@miloop.ai 告诉我们。",
      "fl.demo.error.timeout": "这次执行的时间超过预期，已经中止。通常是服务器还在启动，请再试一次。"
    },

    "zh-Hant": {
      "fl.meta.title": "FactLoop Newsroom｜Miloop AI",
      "fl.meta.description": "一套多 Agent 新聞編輯室，把任何語言的關鍵字變成經過查證、有來源可循的報導，查不出來的就不發。歡迎實際試跑。",
      "fl.back": "返回首頁",
      "fl.hero.eyebrow": "作品案例",
      "fl.hero.title.pre": "一個會",
      "fl.hero.title.em": "自我查證",
      "fl.hero.title.post": "的新聞編輯室。",
      "fl.hero.lede": "FactLoop Newsroom 接受任何語言的主題，回傳一篇用同樣語言寫成的報導，內容只來自它能指給您看的來源。如果它沒辦法查證自己剛寫下的東西，它就什麼都不發。這一頁往下拉，您可以自己跑一次。",
      "fl.spec.role": "角色",
      ...
      "fl.problem.title": "AI 寫得快，但那從來不是難的部分。",
      "fl.problem.body": "把一個新聞主題丟給語言模型，幾秒鐘內就會拿到一篇乾淨俐落的稿子。其中有些是真的，其餘的讀起來一模一樣。對於趕截止時間的人來說，這不是省下時間，而是把風險轉嫁給最後讀到的那個人。所以真正值得解決的問題，不是怎麼讓 AI 寫得更快，而是怎麼在東西發出去之前，就知道哪幾句話真的有依據。",
      "fl.how.eyebrow": "運作方式",
      ...
      "fl.stage5.name": "發布",
      "fl.stage5.body": "把成稿整理成搜尋引擎和 AI 助理讀得懂的形式，過程中不新增任何內容。",
      "fl.stage.retry": "撰稿階段有兩次機會，修正查證挑出來的問題。如果第三版仍然站不住腳，整次執行就此打住，什麼都不發布。您在下面的示範 裡很可能會遇到這種情況。",
      "fl.principle.eyebrow": "設計取捨",
      "fl.principle.title": "三個決定了成敗的選擇。",
      "fl.principle1.title": "蒐集事實的那一步，刻意不放 AI",
      ...
      "fl.demo.note": "這個示範 每次執行都會實際搜尋新聞，並呼叫好幾個 AI 模型，因此有使用次數限制。請試個兩三個主題就好，不必一口氣試十幾個。",
      "fl.demo.submit": "開始執行",
      "fl.demo.running": "執行中…",
      "fl.demo.loading.start": "正在啟動。",
      "fl.demo.loading.waking": "這個示範 的伺服器閒置時會休眠，喚醒大約需要一分鐘，所以當天第一次執行會特別慢。這不是出錯。",
      ...
      "fl.demo.limit.body": "這個示範 有次數限制，用來控制實際的執行成本。請稍後再試。",
      "fl.demo.error.title": "出了點問題。",
      "fl.demo.error.body": "這次執行沒有完成。請稍後再試一次；如果一直這樣，歡迎寄郵件到 info@miloop.ai 告訴我們。",
