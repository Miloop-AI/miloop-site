...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "teaser.statement": "Most AI looks good in a demo. Few AI systems survive contact with a real deadline, a real client, or a real edge case. We build the kind that do, with evaluation built into every pipeline from day one.",
      ...
      "about.p2": "That standard shapes every system we build, from the first prototype through production deployment.",
    ...
    "zh-Hans": {
      ...
      "teaser.statement": "多数 AI 在展示里都很好看。但很少有 AI 系统撑得过真实的截止日期、真实的客户、真实的边缘情况。我们做的就是能撑住的那种，评估从第一天起就写进流水线里。",
      ...
      "about.p2": "这个标准贯穿我们做的每一套系统，从第一版原型一直到生产环境上线。",
    ...
    "zh-Hant": {
      ...
      "teaser.statement": "多數 AI 在展示裡都很好看。但很少有 AI 系統撐得過真實的截止日期、真實的客戶、真實的邊緣情況。我們做的就是能撐住的那種，評估從第一天起就寫進流水線裡。",
      ...
      "about.p2": "這個標準貫穿我們做的每一套系統，從第一版原型一直到生產環境上線。",
