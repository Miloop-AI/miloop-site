...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "about.founder.p3": "She graduated from the University of Michigan with a Master of Applied Data Science, and brings a background in media production and news editing as well. Both disciplines rely on the same core skill: building something a person can actually trust.",
    ...
    "zh-Hans": {
      ...
      "about.founder.p3": "她毕业于密歇根大学应用数据科学硕士项目，另外还有媒体制作与新闻编辑的背景。这两件事其实靠的是同一种能力：做出一个人真的敢信的东西。",
    ...
    "zh-Hant": {
      ...
      "about.founder.p3": "她畢業於密西根大學應用資料科學碩士學程，另外還有媒體製作與新聞編輯的背景。這兩件事其實靠的是同一種能力：做出一個人真的敢信的東西。",
