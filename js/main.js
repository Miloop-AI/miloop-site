...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "teaser.statement": "Most AI looks good in a demo. Few systems hold up against a real deadline and a real edge case. We build the kind that do, and hand it over running on your own infrastructure, with a runbook your team can change. The saving shows up in the first month. The capability stays with the company.",
    ...
    "zh-Hans": {
      ...
      "teaser.statement": "多数 AI 在演示中表现良好，但少有系统能承受真实的交付期限与边缘案例。我们搭建的正是能承受的那一类，交付时部署在您自有的环境上，并附一份您的团队可以自行修改的操作手册。成本在第一个月就省下来了，而能力会留在公司里。",
    ...
    "zh-Hant": {
      ...
      "teaser.statement": "多數 AI 在展示中表現良好，但少有系統能承受真實的交付期限與邊緣案例。我們建置的正是能承受的那一類，交付時部署在您自有的環境上，並附一份您的團隊可以自行修改的操作手冊。成本在第一個月就省下來了，而能力會留在公司裡。",
