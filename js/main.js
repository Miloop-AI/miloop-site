...
(function () {
  ...
  var dict = {
    ...
    "zh-Hans": {
      ...
      "about.founder.p3": "她拥有密歇根大学应用数据科学硕士学位，在那之前的背景横跨影视导演、媒体制作、新闻编辑、编程与数据分析。这些工作难的地方都一样。做出来的东西，别人要信得过才行。",
    ...
    "zh-Hant": {
      ...
      "about.founder.p3": "她擁有密西根大學應用資料科學碩士學位，在那之前的背景橫跨影視導演、媒體製作、新聞編輯、程式設計與資料分析。這些工作難的地方都一樣。做出來的東西，別人要信得過才行。",
