...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "about.founder.p3": "She graduated from the University of Michigan with a Master of Applied Data Science. Her other background spans film and TV directing, video production, programming, and news editing. Those jobs are all hard in the same way. Whatever you make, someone has to be able to trust it.",
    ...
    "zh-Hans": {
      ...
      "about.founder.p3": "她毕业于密歇根大学应用数据科学硕士项目。另外她还有影视导演、媒体制作、编程与新闻编辑的背景。这些工作难的地方都一样。做出来的东西，别人要信得过才行。",
    ...
    "zh-Hant": {
      ...
      "about.founder.p3": "她畢業於密西根大學應用資料科學碩士學程。另外她還有影視導演、媒體製作、程式設計與新聞編輯的背景。這些工作難的地方都一樣。做出來的東西，別人要信得過才行。",
