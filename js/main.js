...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hp.s1": "Is the system I already use getting things wrong?",
      "hp.r1": "One check turned up 16 of these",
      "hp.s2": "If I let AI do the whole job, will it make things up?",
      "hp.r2": "This draft never went out",
      "hp.s3": "Can it answer questions about my own company's rules?",
    ...
    "zh-Hans": {
      ...
      "hp.s1": "我已经在用的系统，有没有正在出错？",
      "hp.r1": "一次盘查，查出 16 件",
      "hp.s2": "让 AI 自己做完一整件事，它会不会乱编？",
      "hp.r2": "这一版没有发出去",
      "hp.s3": "它答得出我们公司内部的规定吗？",
    ...
    "zh-Hant": {
      ...
      "hp.s1": "我已經在用的系統，有沒有正在出錯？",
      "hp.r1": "一次盤查，查出 16 件",
      "hp.s2": "讓 AI 自己做完一整件事，它會不會亂編？",
      "hp.r2": "這一版沒有發出去",
      "hp.s3": "它答得出我們公司內部的規定嗎？",
      "hp.r3": "它答完 HR 那份，又去翻了 IT 那份",
      "hp.s4": "它會不會沒問過我就動手？",
