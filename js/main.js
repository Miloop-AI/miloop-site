...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hp.s1": "Nobody had reported a problem. One check turned up 16.",
      "hp.r1": "Nothing crashed, so nobody noticed",
      "hp.s2": "One article, from research to publication, with nobody in the middle.",
      "hp.r2": "It sent back the draft it had just written",
      "hp.s3": "An employee asked one HR question. The answer was in two different documents.",
      "hp.r3": "It answered the HR question, then went and read the IT one",
      "hp.s4": "An employee said: put me in for three days off, 26 to 28 August.",
      "hp.r4": "It stopped here. It gets permission only after you say yes",
      "hp.s5": "We checked our own system. The first run came back perfect.",
      "hp.r5": "A perfect score was too good, so we went and checked where it came from",
      ...
      "sv1.r1": "The screen said <b>submitted</b>. The balance <b>never moved</b>.",
      "sv1.r2": "<b>Nothing anywhere reported a problem.</b> The same three days could be requested over and over.",
      "sv1.fix": "Now, if a change cannot take effect, it stops and says so.",
      "sv2.stage": "02 / BUILD",
      ...
      "sv4.waittx": "Submit a leave request for 3 days, 26 to 28 August, to your manager for approval.",
    ...
    "zh-Hans": {
      ...
      "hp.s1": "没有人回报过问题。一次盘查，查出 16 件。",
      "hp.r1": "它不会当机，所以没有人发现",
      "hp.s2": "一篇稿子，从找数据到发布，中间没有人。",
      "hp.r2": "它把自己刚写好的稿子退了回去",
      "hp.s3": "员工问了一个 HR 问题。答案却在两份不同的文档里。",
      "hp.r3": "它答完 HR 那份，又去翻了 IT 那份",
      "hp.s4": "员工说：帮我请 8/26 到 8/28，三天假。",
      "hp.r4": "它停在这里，等人点头才拿得到权限",
      "hp.s5": "我们验我们自己的系统。第一次拿到满分。",
      "hp.r5": "满分太好看了，所以我们回头查它是怎么来的",
      ...
      "sv1.r1": "画面显示<b>已送出</b>，余额<b>没有动</b>。",
      "sv1.r2": "<b>从头到尾没有一个地方报错。</b>同样那三天，可以一直重复请。",
      "sv1.fix": "现在只要一笔更改不可能生效，就会当场停下来说。",
      "sv2.stage": "02 ／ 构建",
      ...
      "sv4.k3": "天数",
      "sv4.wait": "等待您的确认",
      "sv4.waittx": "送出一张 8/26 到 8/28、共 3 天的请假单，交给您的主管核准。",
    ...
    "zh-Hant": {
      ...
      "hp.s1": "沒有人回報過問題。一次盤查，查出 16 件。",
      "hp.r1": "它不會當機，所以沒有人發現",
      "hp.s2": "一篇稿子，從找資料到發佈，中間沒有人。",
      "hp.r2": "它把自己剛寫好的稿子退了回去",
      "hp.s3": "員工問了一個 HR 問題。答案卻在兩份不同的文件裡。",
      "hp.r3": "它答完 HR 那份，又去翻了 IT 那份",
      "hp.s4": "員工說：幫我請 8/26 到 8/28，三天假。",
      "hp.r4": "它停在這裡，等人點頭才拿得到權限",
      "hp.s5": "我們驗我們自己的系統。第一次拿到滿分。",
      "hp.r5": "滿分太好看了，所以我們回頭查它是怎麼來的",
      ...
      "sv1.r1": "畫面顯示<b>已送出</b>，餘額<b>沒有動</b>。",
      "sv1.r2": "<b>從頭到尾沒有一個地方報錯。</b>同樣那三天，可以一直重複請。",
      "sv1.fix": "現在只要一筆更改不可能生效，就會當場停下來說。",
      "sv2.stage": "02 ／ 構建",
      ...
      "sv4.k3": "天數",
      "sv4.wait": "等待您的確認",
      "sv4.waittx": "送出一張 8/26 到 8/28、共 3 天的請假單，交給您的主管核准。",
