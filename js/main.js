...
(function () {
  ...
  var dict = {
    ...
    "zh-Hans": {
      ...
      "hero.sub": "流程靠人手，赔的是时间和预算；AI 没人核查，赔的是信任。Miloop AI 交付的系统是要长期跑在生产环境里的：内容自动化、知识问答、语音助理，以及更多场景。每一套都自带一层独立评估，问题在传到您客户手上之前就被拦下来。",
      ...
      "services.title": "从第一次摸底，到上线之后的长期维护。",
      "s1.title": "AI 就绪度评估",
      "s1.body": "不确定 AI 在您的业务里到底能派上什么用场？我们把您现在的工作流程、还有已经在跑的 AI 系统整个过一遍，把幻觉风险、白花的钱，以及最该先动手的那一块指出来。您拿到的是一份<strong>排好优先级的具体路线图</strong>。",
      "s2.title": "工作流与内容自动化",
      "s2.body": "分类、翻译、起草、查证、发布——这些原本要一步步手动做的事，我们把它们接成一条流水线，<strong>交付时间从几小时压到几分钟</strong>。底下是生产级的基础设施，交接完之后还得继续跑很久。",
      "s3.title": "生成式 AI 与知识系统",
      "s3.body": "往一头是检索增强系统，您的团队可以直接问内部文档，答案句句有出处；往另一头是轻量微调的模型，写出来的东西就是您品牌说话的样子。<strong>生成式 AI，先做到准，再谈惊艳。</strong>",
      "s4.title": "Agent 系统与集成",
      "s4.body": "<strong>AI 能查您的数据库、能操作您的内部工具，多步骤的任务从头做到尾。</strong>多 Agent 系统，加上通过 MCP 做的工具集成；也包括语音助理，用在腾不出手、只能靠说的场合。",
      "s5.title": "评估、部署与持续支持",
      "s5.body": "每一套系统交付时都带着自己的及格线：跨模型的评估框架，赶在您的用户之前先把幻觉抓出来。上线以后，云上的基础设施和日常维护由我们接着管，<strong>可靠性不该变成您的麻烦</strong>。",
      ...
      "result2.body": "一款双语语音陪伴助理，是<strong>最早一批</strong>专门为美国华裔老年群体做的 AI 陪伴应用之一，目前处于预发布阶段。",
      "result3.tag": "模型微调",
      ...
      "about.p1": "Miloop AI 设计并交付跑在生产环境里的 AI 系统：有从头到尾接管内容流程的多 Agent 流水线，有检索增强系统，也有为某一个品牌语气单独微调的模型。每一套都自带评估层，而且这一层从第一个设计决定起就长在流水线里，准确性每一步都验过。",
      "about.pullquote": "准确跟不上，快就不算数。",
      "about.p2": "这个标准贯穿 Miloop AI 做的每一套系统，从第一版原型一直到生产环境上线。",
      "about.p3": "如果有个流程一直在吃掉本不该花的时间，或者您手上那套 AI 系统自己都还不太敢信，这正是 Miloop AI 会接手的问题。",
      "about.founder.eyebrow": "创始人",
      "about.founder.p1": "Miloop AI 由 Yingying Sun 创立。她的技术生涯从一家财富500强科技公司开始，在那里做了多年大型项目管理，把跨职能团队之间的报告口径统一了起来。系统要怎么做才撑得住规模，她的判断就是在那几年里长出来的。",
      "about.founder.p2": "这份底子后来延续到了她的 AI 工程工作里。她把高风险的编辑流程自动化过，翻译、查证、排版都在内；也为双语的老年用户做过多模态语音 AI 系统，那种场合里，可靠性是压倒一切的设计前提。",
      "about.founder.p3": "她毕业于密歇根大学应用数据科学硕士项目，另外还有视觉叙事的背景。这两件事其实靠的是同一种能力：做出一个人真的敢信的东西。",
    ...
    "zh-Hant": {
      ...
      "hero.sub": "流程靠人手，賠的是時間和預算；AI 沒人核查，賠的是信任。Miloop AI 交付的系統是要長期跑在生產環境裡的：內容自動化、知識問答、語音助理，以及更多場景。每一套都自帶一層獨立評估，問題在傳到您客戶手上之前就被攔下來。",
      ...
      "services.title": "從第一次盤點，到上線之後的長期維護。",
      "s1.title": "AI 就緒度評估",
      "s1.body": "不確定 AI 在您的業務裡到底能派上什麼用場？我們把您現在的工作流程、還有已經在跑的 AI 系統整個過一遍，把幻覺風險、白花的錢，以及最該先動手的那一塊指出來。您拿到的是一份<strong>排好優先順序的具體路線圖</strong>。",
      "s2.title": "工作流與內容自動化",
      "s2.body": "分類、翻譯、起草、查證、發布——這些原本要一步步手動做的事，我們把它們接成一條流水線，<strong>交付時間從幾小時壓到幾分鐘</strong>。底下是生產級的基礎設施，交接完之後還得繼續跑很久。",
      "s3.title": "生成式 AI 與知識系統",
      "s3.body": "往一頭是檢索增強系統，您的團隊可以直接問內部文件，答案句句有出處；往另一頭是輕量微調的模型，寫出來的東西就是您品牌說話的樣子。<strong>生成式 AI，先做到準，再談驚豔。</strong>",
      "s4.title": "Agent 系統與整合",
      "s4.body": "<strong>AI 能查您的資料庫、能操作您的內部工具，多步驟的任務從頭做到尾。</strong>多 Agent 系統，加上透過 MCP 做的工具整合；也包括語音助理，用在騰不出手、只能靠說的場合。",
      "s5.title": "評估、部署與持續支援",
      "s5.body": "每一套系統交付時都帶著自己的及格線：跨模型的評估框架，趕在您的使用者之前先把幻覺抓出來。上線以後，雲端的基礎設施和日常維護由我們接著管，<strong>可靠性不該變成您的麻煩</strong>。",
      ...
      "result2.body": "一款雙語語音陪伴助理，是<strong>最早一批</strong>專門為美國華裔老年群體做的 AI 陪伴應用之一，目前處於預發布階段。",
      "result3.tag": "模型微調",
      ...
      "about.p1": "Miloop AI 設計並交付跑在生產環境裡的 AI 系統：有從頭到尾接管內容流程的多 Agent 流水線，有檢索增強系統，也有為某一個品牌語氣單獨微調的模型。每一套都自帶評估層，而且這一層從第一個設計決定起就長在流水線裡，準確性每一步都驗過。",
      "about.pullquote": "準確跟不上，快就不算數。",
      "about.p2": "這個標準貫穿 Miloop AI 做的每一套系統，從第一版原型一直到生產環境上線。",
      "about.p3": "如果有個流程一直在吃掉本不該花的時間，或者您手上那套 AI 系統自己都還不太敢信，這正是 Miloop AI 會接手的問題。",
      "about.founder.eyebrow": "創辦人",
      "about.founder.p1": "Miloop AI 由 Yingying Sun 創立。她的技術生涯從一家財富500強科技公司開始，在那裡做了多年大型專案管理，把跨職能團隊之間的報告口徑統一了起來。系統要怎麼做才撐得住規模，她的判斷就是在那幾年裡長出來的。",
      "about.founder.p2": "這份底子後來延續到了她的 AI 工程工作裡。她把高風險的編輯流程自動化過，翻譯、查證、排版都在內；也為雙語的年長使用者做過多模態語音 AI 系統，那種場合裡，可靠性是壓倒一切的設計前提。",
      "about.founder.p3": "她畢業於密西根大學應用資料科學碩士學程，另外還有視覺敘事的背景。這兩件事其實靠的是同一種能力：做出一個人真的敢信的東西。",
