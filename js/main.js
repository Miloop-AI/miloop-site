...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hero.offer2.desc": "A simple chat screen, backed by a model fine-tuned on your own material, so anyone on your team can get complex work done without any technical training.",
      ...
      "teaser.statement": "Most AI looks good in a demo. Few systems hold up against a real deadline and a real edge case. We build the kind that do, and hand it over running on your own infrastructure, with a runbook your team can change.",
      "teaser.close": "The saving shows up in the first month. The capability stays with the company.",
    ...
    "zh-Hans": {
      ...
      "hero.sub": "人工作业耗费的是时间；AI 若不可信，耗费的就是金钱。我们搭建具备自我验证能力的 AI 系统，自动化您最主要的作业瓶颈，包括：",
      "hero.offer1.name": "完整的流程，从头到尾",
      "hero.offer1.desc": "一份报价、一张发票、一份月报：原本需经过三个人、四套工具的作业链，现在可自行完成。",
      "hero.offer2.name": "为您训练的 AI 助理",
      "hero.offer2.desc": "界面只是一个简单的对话框，背后是以您自有材料微调过的模型，让您团队里的任何人不需要技术背景，也能完成复杂的工作。",
      ...
      "teaser.statement": "多数 AI 在演示中表现良好，但少有系统能承受真实的交付期限与边缘案例。我们搭建的正是能承受的那一类，交付时部署在您自有的环境上，并附一份您的团队可以自行修改的操作手册。",
      "teaser.close": "成本在第一个月就省下来了，而能力会留在公司里。",
    ...
    "zh-Hant": {
      ...
      "hero.sub": "人工作業耗費的是時間；AI 若不可信，耗費的就是金錢。我們建置具備自我驗證能力的 AI 系統，自動化您最主要的作業瓶頸，包括：",
      "hero.offer1.name": "完整的流程，從頭到尾",
      "hero.offer1.desc": "一份報價、一張發票、一份月報：原本需經過三個人、四套工具的作業鏈，現在可自行完成。",
      "hero.offer2.name": "為您訓練的 AI 助理",
      "hero.offer2.desc": "介面只是一個簡單的對話框，背後是以您自有材料微調過的模型，讓您團隊裡的任何人不需要技術背景，也能完成複雜的工作。",
      ...
      "teaser.statement": "多數 AI 在展示中表現良好，但少有系統能承受真實的交付期限與邊緣案例。我們建置的正是能承受的那一類，交付時部署在您自有的環境上，並附一份您的團隊可以自行修改的操作手冊。",
      "teaser.close": "成本在第一個月就省下來了，而能力會留在公司裡。",
