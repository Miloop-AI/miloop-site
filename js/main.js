...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hero.offer2.name": "A plain chat box, with a model trained for you behind it",
      "hero.offer2.desc": "Nobody has to learn how to talk to AI. People ask in their own words, by text or by voice, and the model answering was trained on your own material.",
      "hero.offer3.name": "Agents that finish the task, not just answer it",
      "hero.offer3.desc": "AI that works across your systems end to end, and stops for a person at the steps you choose.",
    ...
    "zh-Hans": {
      ...
      "hero.offer1.desc": "自动搜集资料、撰写初稿，并在发布前逐一比对每项陈述与其来源。",
      "hero.offer2.name": "一个谁都会用的对话界面，背后是为您训练的模型",
      "hero.offer2.desc": "无须学习如何与 AI 对话。使用者以日常语言提问，可以打字也可以直接说话，而负责回答的模型是以您自有的材料训练而成。",
      "hero.offer3.name": "会动手完成任务的 Agent，而不只是回答",
      "hero.offer3.desc": "AI 跨越您既有的各套系统完成整件事，并在您指定的环节停下来等人确认。",
    ...
    "zh-Hant": {
      ...
      "hero.offer2.name": "一個誰都會用的對話介面，背後是為您訓練的模型",
      "hero.offer2.desc": "無須學習如何與 AI 對話。使用者以日常語言提問，可以打字也可以直接說話，而負責回答的模型是以您自有的材料訓練而成。",
      "hero.offer3.name": "會動手完成任務的 Agent，而不只是回答",
      "hero.offer3.desc": "AI 跨越您既有的各套系統完成整件事，並在您指定的環節停下來等人確認。",
