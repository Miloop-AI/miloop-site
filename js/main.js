...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "privacy.providers.body": "We use Resend to deliver the emails generated by the contact panel, and Vercel to host this website. These providers process data on our behalf and are bound by their own privacy and security practices.",
    ...
    "zh-Hans": {
      ...
      "privacy.providers.body": "我们使用Resend发送对话面板产生的邮件，使用Vercel托管本网站。这些服务商代表我们处理数据，并各自遵循自己的隐私与安全规范。",
    ...
    "zh-Hant": {
      ...
      "privacy.providers.body": "我們使用Resend發送對話面板產生的郵件，使用Vercel託管本網站。這些服務商代表我們處理資料，並各自遵循自己的隱私與安全規範。",
