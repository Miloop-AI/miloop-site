...
(function () {
  ...
  var dict = {
    ...
    "zh-Hans": {
      ...
      "teaser.statement": "多数 AI 在展示里都很好看。但很少有 AI 系统撑得过真实的截止日期和真实的边缘情况。我们做的就是能撑住的那种，评估从第一天起就写进流水线里。",
      "teaser.cta.about": "了解我们",
      "about.eyebrow": "关于我们",
      "about.back": "返回首页",
      "about.lede1": "Miloop AI 的标准很简单：自动化要经得起真实、长期的使用。",
      "about.p1": "我们做的是真正跑在生产环境里的 AI 系统，撑得过展示之后的真实使用：有从头到尾接管内容流程的多 Agent 流水线，有能直接问您自己文档的知识系统，也有为某个品牌语气单独训练的模型。每一套都自带评估层，从第一天就写进流水线里，准确性一路都验过。",
      ...
      "about.founder.p2": "她把高风险的编辑流程自动化过，翻译、查证、排版都在内；也为双语的年长用户做过多模态语音 AI 系统，那种场合里，可靠性是压倒一切的设计前提。",
      "about.founder.p3": "她毕业于密西根大学应用数据科学硕士学程。另外她还有影视导演、媒体制作、编程与新闻编辑的背景。这几行里难的地方都一样，是让人愿意相信你做出来的东西。",
