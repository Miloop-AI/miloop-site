...
(function () {
  ...
  var dict = {
    ...
    "zh-Hans": {
      ...
      "about.founder.p2": "后来她做的 AI，都用在出错代价很高的地方。她把复杂的编辑流程自动化，为特定任务微调定制化的语言模型，也为双语的老年用户打造多模态语音 AI 系统，那种场合里，可靠性是压倒一切的第一顺位。",
    ...
    "zh-Hant": {
      ...
      "about.founder.p2": "後來她做的 AI，都用在出錯代價很高的地方。她把複雜的編輯流程自動化，為特定任務微調客製化的語言模型，也為雙語的年長使用者打造多模態語音 AI 系統，那種場合裡，可靠性是壓倒一切的第一順位。",
