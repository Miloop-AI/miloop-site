...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "result3.lead": "$0.70",
      "result3.leadsub": "to train it, on one consumer GPU",
      "result2.lead": "App Store &middot; Google Play",
      "result2.leadsub": "anyone can download it today",
      "result1.lead": "Hours &rarr; 10 minutes",
      "result1.leadsub": "per article",
      "result1.tag": "Content Automation",
      "result1.title": "A Bilingual News Publisher",
      "result1.body": "A multi-model content pipeline cut per-article production time, and reduced overall content cycle time by <strong>40%</strong>.",
      ...
      "result3.body": "A generic model writes generically. This one was trained on real editorial writing, <strong>a fraction of the cost</strong> of building a custom model from scratch.",
    ...
    "zh-Hans": {
      ...
      "result3.lead": "$0.70",
      "result3.leadsub": "训练成本，用一张消费级显卡",
      "result2.lead": "App Store &middot; Google Play",
      "result2.leadsub": "任何人今天都下载得到",
      "result1.lead": "几小时 &rarr; 10 分钟",
      "result1.leadsub": "每篇文章",
      "result1.tag": "内容自动化",
      "result1.title": "一家双语新闻机构",
      "result1.body": "一条多模型的内容流水线，把单篇稿件的制作时间压下来，整体内容周期也缩短了 <strong>40%</strong>。",
      "result2.tag": "语音 AI",
      ...
      "result3.body": "通用模型写出来就是通用的东西。这一个是拿真实的编辑稿训练的，<strong>成本只是从零打造的零头</strong>。",
    ...
    "zh-Hant": {
      ...
      "result3.lead": "$0.70",
      "result3.leadsub": "訓練成本，用一張消費級顯示卡",
      "result2.lead": "App Store &middot; Google Play",
      "result2.leadsub": "任何人今天都下載得到",
      "result1.lead": "幾小時 &rarr; 10 分鐘",
      "result1.leadsub": "每篇文章",
      "result1.tag": "內容自動化",
      "result1.title": "一家雙語新聞機構",
      "result1.body": "一條多模型的內容流水線，把單篇稿件的製作時間壓下來，整體內容週期也縮短了 <strong>40%</strong>。",
      "result2.tag": "語音 AI",
      ...
      "result3.body": "通用模型寫出來就是通用的東西。這一個是拿真實的編輯稿訓練的，<strong>成本只是從零打造的零頭</strong>。",
