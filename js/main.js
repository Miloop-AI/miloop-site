...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "about.founder.p3": "She graduated from the University of Michigan with a Master of Applied Data Science. Her other background spans film and video directing, video production, programming, and news editing. All of it relies on the same core skill: building something a person can actually trust.",
    ...
    "zh-Hans": {
      ...
      "about.founder.p3": "她毕业于密歇根大学应用数据科学硕士项目。另外她还有影视导演、影像制作、编程与新闻编辑的背景。这些靠的都是同一种能力：做出一个人真的敢信的东西。",
    ...
    "zh-Hant": {
      ...
      "about.founder.p3": "她畢業於密西根大學應用資料科學碩士學程。另外她還有影視導演、影像製作、程式設計與新聞編輯的背景。這些靠的都是同一種能力：做出一個人真的敢信的東西。",
