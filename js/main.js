...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hp.r1": "One check turned up 16 faults nobody had reported",
      "hp.s2": "One article, from research to publication, with nobody in the middle.",
      "hp.r2": "It sent back the draft it had just written",
      "hp.s3": "An employee asked about working from another country for a few weeks.",
      ...
      "sv1.fix": "Now a change that does not really take effect stops and raises an error.",
      "sv2.stage": "02 / BUILD",
    ...
    "zh-Hans": {
      ...
      "sv1.fix": "现在只要一笔更改没有真的生效，就会当场停下来报错。",
      "sv2.stage": "02 ／ 构建",
    ...
    "zh-Hant": {
      ...
      "sv1.fix": "現在只要一筆更改沒有真的生效，就會當場停下來報錯。",
      "sv2.stage": "02 ／ 構建",
