...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hero.heading.post": "",
      "hero.sub": "Manual work costs you hours you don't have. AI you can't trust costs you customers, and money you won't get back. We build AI systems that take the busywork off your plate and check their own work before it reaches your customers.",
      ...
      "sv1.head": "A change that never took effect was reported as done.",
      "sv1.r1": "The leave request <b>was created</b>. The balance <b>never moved</b>.",
      "sv1.r2": "<b>Nothing anywhere reported a problem.</b> The same three days could then be requested without limit.",
      "sv1.fix": "Now a change that cannot take effect stops and says so.",
      "sv2.stage": "02 / BUILD",
      ...
      "sv4.note": "<b>Nothing has been submitted.</b> Only after you answer does it get permission to run, and that permission covers these exact details and nothing else.",
      "sv4.b1": "Confirm",
      "sv4.b2": "Change it",
      "sv4.b3": "Cancel",
      "sv5.stage": "05 / VERIFY",
      ...
      "sv5.kill": "Discarded",
      "sv5.why": "An earlier validation reached <b>perfect agreement</b>. Its answer key had been revised after reading the judge&rsquo;s own output, so it was no longer measuring the same thing. That run was thrown out, and the lower score from the redo is the one we published.",
      "sv.realrun": "real run",
      ...
      "about.founder.p1": "Miloop AI was founded by an AI engineer whose technical career began at a Fortune 500 technology company, where she spent years managing large-scale programs and standardizing reporting across cross-functional teams. Those years are where she learned to tell whether a system will hold up at scale.",
      "about.founder.p2": "She has automated high-stakes editorial workflows, including translation, fact-checking, and formatting, and built multi-modal voice AI systems for elderly, bilingual users, where reliability was the primary design constraint.",
      "about.founder.p3": "She graduated from the University of Michigan with a Master of Applied Data Science. Her other background spans film and TV directing, video production, programming, and news editing. In every one of them, the hard part was getting someone to trust the result.",
    ...
    "zh-Hans": {
      ...
      "hero.heading.pre": "把琐碎的活交给会",
      "hero.heading.em": "自我验证",
      "hero.heading.post": "的 AI 系统",
      "hero.sub": "人工处理，赔的是您抽不出来的时间；AI 没人把关，赔的是客户，还有要不回来的钱。我们做的 AI 系统，替您把琐碎的活接过去，在交到客户手上之前自己先查一遍。",
      "hero.promise": "您不用先搞懂 AI，只要有一个值得解决的问题就行。",
      ...
      "sv1.head": "一笔根本没生效的更改，系统回报成功。",
      "sv1.r1": "请假单<b>创建了</b>，余额<b>没有动</b>。",
      "sv1.r2": "<b>从头到尾没有一个地方报错。</b>同样那三天可以无限次重复请。",
      "sv1.fix": "现在只要一笔更改不可能生效，就会当场停下来报错。",
      "sv2.stage": "02 ／ 构建",
      ...
      "sv4.note": "<b>什么都还没送出。</b>您回答之后，它才拿得到运行许可，而且那份许可只对上面这几项有效。",
      "sv4.b1": "确认",
      "sv4.b2": "改一下",
      "sv4.b3": "取消",
      "sv5.stage": "05 ／ 验证",
      ...
      "sv5.kill": "作废",
      "sv5.why": "更早一次验证拿到<b>完全一致</b>。但那份答案卷是在看过评审的输出之后才修改的，量的已经不是同一件事，所以整笔丢掉，重做之后那个比较难看的分数才是我们公布的。",
      "sv.realrun": "实际运行",
      "s1.title": "AI 就绪度评估",
      ...
      "demo2.tag": "RAG 评估",
      "demo2.name": "Driftboard RAG Eval",
      "demo2.tagline": "一套 RAG 评估框架，拿一个虚构知识库做压力测试。它量的是系统答不出来的时候会怎么做，连评判者自己的盲点也一起查。",
      ...
      "demo3.tag": "Agent 权限",
      "demo3.name": "DeskLoop",
      "demo3.tagline": "一个把权限检查放在模型外面的 IT 与 HR 助手：那道检查跑在它自己的工具服务器里。跟它讲道理换不到权限，一次确认也只属于一个动作，别的都不算。",
      "demo3.cta": "观看演示录屏",
      "teaser.eyebrow": "关于 Miloop AI",
      "teaser.statement": "多数 AI 在演示里都很好看。但很少有 AI 系统撑得过真实的截止日期和真实的边缘情况。我们做的就是能撑住的那种，评估从第一天起就写进流水线里。",
      "teaser.cta.about": "了解我们",
      "about.eyebrow": "关于我们",
      "about.back": "返回首页",
      "about.lede1": "Miloop AI 的标准很简单：自动化要经得起真实、长期的使用。",
      "about.p1": "我们做的是真正跑在生产环境里的 AI 系统，撑得过演示之后的真实使用：有从头到尾接管内容流程的多 Agent 流水线，有能直接问您自己文档的知识系统，也有为某个品牌语气单独训练的模型。每一套都自带评估层，从第一天就写进流水线里，准确性一路都验过。",
      "about.pullquote": "准确跟不上，快就不算数。",
      "about.p3": "如果有个流程一直在吃掉本不该花的时间，或者您手上那套 AI 工具自己都还不太敢信，这正是我们会接手的问题。",
      "about.founder.eyebrow": "创始人",
      "about.founder.p1": "Miloop AI 由一位 AI 工程师创立。她的技术生涯从一家财富500强科技公司开始，在那里做了多年大型项目管理，把跨职能团队之间的报告口径统一了起来。一套系统撑不撑得住规模，她是在那几年里学会怎么看的。",
      "about.founder.p2": "她把高风险的编辑流程自动化过，翻译、查证、排版都在内；也为双语的老年用户做过多模态语音 AI 系统，那种场合里，可靠性是压倒一切的设计前提。",
      "about.founder.p3": "她毕业于密歇根大学应用数据科学硕士项目。另外她还有影视导演、媒体制作、编程与新闻编辑的背景。这几行里难的地方都一样，是让人愿意相信你做出来的东西。",
    ...
    "zh-Hant": {
      ...
      "hero.heading.pre": "把瑣碎的活交給會",
      "hero.heading.em": "自我驗證",
      "hero.heading.post": "的 AI 系統",
      "hero.sub": "人工處理，賠的是您抽不出來的時間；AI 沒人把關，賠的是客戶，還有要不回來的錢。我們做的 AI 系統，替您把瑣碎的活接過去，在交到客戶手上之前自己先查一遍。",
      "hero.promise": "您不用先搞懂 AI，只要有一個值得解決的問題就行。",
      ...
      "sv1.head": "一筆根本沒生效的更改，系統回報成功。",
      "sv1.r1": "請假單<b>建立了</b>，餘額<b>沒有動</b>。",
      "sv1.r2": "<b>從頭到尾沒有一個地方報錯。</b>同樣那三天可以無限次重複請。",
      "sv1.fix": "現在只要一筆更改不可能生效，就會當場停下來報錯。",
      "sv2.stage": "02 ／ 構建",
      ...
      "sv4.note": "<b>什麼都還沒送出。</b>您回答之後，它才拿得到執行許可，而且那份許可只對上面這幾項有效。",
      "sv4.b1": "確認",
      "sv4.b2": "改一下",
      "sv4.b3": "取消",
      "sv5.stage": "05 ／ 驗證",
      ...
      "sv5.kill": "作廢",
      "sv5.why": "更早一次驗證拿到<b>完全一致</b>。但那份答案卷是在看過評審的輸出之後才修改的，量的已經不是同一件事，所以整筆丟掉，重做之後那個比較難看的分數才是我們公布的。",
      "sv.realrun": "實際執行",
      "s1.title": "AI 就緒度評估",
      ...
      "demo2.tag": "RAG 評估",
      "demo2.name": "Driftboard RAG Eval",
      "demo2.tagline": "一套 RAG 評估框架，拿一個虛構知識庫做壓力測試。它量的是系統答不出來的時候會怎麼做，連評判者自己的盲點也一起查。",
      ...
      "demo3.tag": "Agent 權限",
      "demo3.name": "DeskLoop",
      "demo3.tagline": "一個把權限檢查放在模型外面的 IT 與 HR 助手：那道檢查跑在它自己的工具伺服器裡。跟它講道理換不到權限，一次確認也只屬於一個動作，別的都不算。",
      "demo3.cta": "觀看示範錄影",
      "teaser.eyebrow": "關於 Miloop AI",
      "teaser.statement": "多數 AI 在展示裡都很好看。但很少有 AI 系統撐得過真實的截止日期和真實的邊緣情況。我們做的就是能撐住的那種，評估從第一天起就寫進流水線裡。",
      "teaser.cta.about": "瞭解我們",
      "about.eyebrow": "關於我們",
      "about.back": "返回首頁",
      "about.lede1": "Miloop AI 的標準很簡單：自動化要經得起真實、長期的使用。",
      "about.p1": "我們做的是真正跑在生產環境裡的 AI 系統，撐得過展示之後的真實使用：有從頭到尾接管內容流程的多 Agent 流水線，有能直接問您自己文件的知識系統，也有為某個品牌語氣單獨訓練的模型。每一套都自帶評估層，從第一天就寫進流水線裡，準確性一路都驗過。",
      "about.pullquote": "準確跟不上，快就不算數。",
      "about.p3": "如果有個流程一直在吃掉本不該花的時間，或者您手上那套 AI 工具自己都還不太敢信，這正是我們會接手的問題。",
      "about.founder.eyebrow": "創辦人",
      "about.founder.p1": "Miloop AI 由一位 AI 工程師創立。她的技術生涯從一家財富500強科技公司開始，在那裡做了多年大型專案管理，把跨職能團隊之間的報告口徑統一了起來。一套系統撐不撐得住規模，她是在那幾年裡學會怎麼看的。",
      "about.founder.p2": "她把高風險的編輯流程自動化過，翻譯、查證、排版都在內；也為雙語的年長使用者做過多模態語音 AI 系統，那種場合裡，可靠性是壓倒一切的設計前提。",
      "about.founder.p3": "她畢業於密西根大學應用資料科學碩士學程。另外她還有影視導演、媒體製作、程式設計與新聞編輯的背景。這幾行裡難的地方都一樣，是讓人願意相信你做出來的東西。",
