...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hero.heading.pre": "Every system ships with a ",
      "hero.heading.em": "second opinion",
      "hero.heading.post": " built in.",
      "hero.sub": "Not because the AI might be wrong. Because eventually, it will be. Miloop AI designs and builds production systems, content automation, knowledge assistants, voice agents, where an independent check catches that moment before your customers do.",
      "hero.cta.contact": "Start a conversation",
      "loop.diagnose": "Diagnose",
      "loop.build": "Build",
      "loop.support": "Verify & Support",
      "services.eyebrow": "What we do",
      "services.title": "From first audit to ongoing support.",
      "s1.title": "AI Readiness Assessment",
      "s1.body": "Not sure where AI can actually move the needle in your business? We audit your current workflows and any AI systems already in place, surfacing hallucination risk, wasted spend, and the highest-leverage place to start. You walk away with <strong>a clear roadmap, not a slide deck full of buzzwords</strong>.",
      "s2.title": "Workflow & Content Automation",
      "s2.body": "We turn multi-step manual processes (classification, translation, drafting, fact-checking, publishing) into pipelines that run in <strong>minutes instead of hours</strong>. Built on production infrastructure, not fragile scripts, so it keeps running long after the handoff.",
      ...
      "s4.body": "<strong>AI that doesn't just talk. It acts.</strong> Multi-agent systems and tool integrations (via MCP) that let AI query your databases, operate your internal tools, and handle multi-step tasks end-to-end, including voice-based assistants for hands-free, conversational use cases.",
      ...
      "result2.title": "PéiNín Foundation",
      "result2.body": "A bilingual voice companion, <strong>among the first AI companion apps</strong> built specifically for Chinese American seniors in the U.S.",
      "result2.status": "Pre-launching 2026",
      "result3.tag": "Model Fine-Tuning",
      "result3.title": "Brand-Voice Model Fine-Tune",
      "result3.body": "A generic model writes generically. This one was trained on real editorial writing for <strong>$0.70</strong> on a single consumer GPU, instead of the far higher cost of building a custom model from scratch.",
      "teaser.eyebrow": "About Miloop AI",
      "teaser.statement": "Most AI demos work. Few AI systems survive contact with a real deadline, a real client, or a real edge case. Miloop AI builds the kind that do, with evaluation built into every pipeline from day one, not bolted on after something breaks.",
      "teaser.cta.about": "Learn About Us",
      "about.eyebrow": "About Us",
      "about.lede1": "Miloop AI is built around a simple standard: automation that holds up under real use, not just in a demo.",
      "about.p1": "Miloop AI designs and ships production AI systems, from multi-agent pipelines that handle end-to-end content workflows to retrieval-augmented systems and custom-tuned models built for a specific brand voice. Every system includes its own evaluation layer, built into the pipeline itself rather than added on afterward, so accuracy is verified, not assumed.",
      ...
      "about.founder.p1": "Miloop AI was founded by Yingying Sun. Her technical career began at a Fortune 500 technology company, where she spent years managing large-scale programs and standardizing reporting across cross-functional teams. That experience shaped how she thinks about building systems that hold up at scale, not just in a demo.",
      "about.founder.p2": "That foundation carried into her AI engineering work. She has automated high-stakes editorial workflows, including translation, fact-checking, and formatting, and built multi-modal voice AI systems for elderly, bilingual users, where reliability was not a nice to have. It was the point.",
    ...
    "zh-Hans": {
      ...
      "hero.heading.pre": "每一套系统，都自带一层",
      "hero.heading.em": "独立复核",
      "hero.heading.post": "。",
      "hero.sub": "不是因为AI可能会出错，而是因为它迟早会出错。Miloop AI设计并构建生产级系统：内容自动化、知识问答助理、语音Agent，每一套都配有独立的校验机制，在问题传导到你的用户之前先被发现。",
      ...
      "s1.title": "AI就绪度评估",
      "s1.body": "不确定AI到底能在你的业务里发挥什么作用？我们会审计你现有的工作流程，以及任何已经在使用的AI系统，找出幻觉风险、被浪费的预算，以及最值得优先投入的地方。你拿到的是一份<strong>清晰的路线图，不是一份堆满流行语的PPT</strong>。",
      "s2.title": "工作流与内容自动化",
      "s2.body": "我们把多步骤的人工流程（分类、翻译、起草、事实核查、发布）变成能在<strong>几分钟内跑完，而不是几小时</strong>的流水线。建立在生产级基础设施上，不是脆弱的脚本，交接之后依然能长期稳定运行。",
      "s3.title": "生成式AI与知识系统",
      "s3.body": "从让你的团队能够查询内部文档、给出有据可查答案的检索增强系统，到用你品牌语气说话的轻量微调模型。<strong>生成式AI首先要准确，其次才是让人印象深刻。</strong>",
      "s4.title": "Agent系统与集成",
      "s4.body": "<strong>AI不只是会说，还要会做。</strong>通过MCP实现的多智能体系统和工具集成，让AI能够查询你的数据库、操作你的内部工具，端到端处理多步骤任务，也包括面向免手操作场景的语音助理。",
      "s5.title": "评估、部署与持续支持",
      ...
      "result2.tag": "语音AI",
      "result2.title": "PéiNín Foundation",
      "result2.body": "一款双语语音陪伴助理，是<strong>最早一批</strong>专门为美国华裔老年群体打造的AI陪伴应用之一。",
      "result2.status": "2026年预发布",
      "result3.tag": "模型微调",
      "result3.title": "品牌语气模型微调",
      "result3.body": "通用模型只会说通用的话。这一个基于真实编辑写作内容微调而成，训练成本只要<strong>0.70美元</strong>，用的是一张消费级显卡，而不是从零训练一个定制模型的高昂成本。",
      "teaser.eyebrow": "关于Miloop AI",
      "teaser.statement": "多数AI演示都能跑起来，但很少有AI系统能撑过真实的截止日期、真实的客户、真实的边缘案例。Miloop AI做的就是这种能撑住的系统，评估机制从第一天就写进流水线里，不是等出问题之后才补上。",
      "teaser.cta.about": "了解我们",
      "about.eyebrow": "关于我们",
      "about.lede1": "Miloop AI的标准很简单：自动化要经得起真实使用的考验，而不只是在演示里好看。",
      "about.p1": "Miloop AI设计并交付生产级AI系统，从处理端到端内容流程的多智能体流水线，到检索增强系统，再到为特定品牌语气定制微调的模型。每一套系统都自带评估层，这一层是写进流水线本身的，不是事后补上的，所以准确性是被验证过的，不是被假设的。",
      ...
      "about.founder.p1": "Miloop AI由Yingying Sun创立。她的职业生涯始于一家财富500强科技公司，在那里她多年负责大型项目管理，并在跨职能团队之间统一报告规范。这段经历塑造了她对系统要经得起规模考验、而不只是在演示里好看这件事的理解。",
      "about.founder.p2": "这个基础延伸到了她的AI工程工作中。她自动化过高风险的编辑流程，包括翻译、事实核查和排版，也为双语老年用户构建过多模态语音AI系统，在那里，可靠性不是锦上添花，而是核心目标本身。",
    ...
    "zh-Hant": {
      ...
      "hero.heading.pre": "每一套系統，都自帶一層",
      "hero.heading.em": "獨立複覈",
      "hero.heading.post": "。",
      "hero.sub": "不是因爲AI可能會出錯，而是因爲它遲早會出錯。Miloop AI設計並構建生產級系統：內容自動化、知識問答助理、語音Agent，每一套都配有獨立的校驗機制，在問題傳導到你的用戶之前先被發現。",
      ...
      "s1.title": "AI就緒度評估",
      "s1.body": "不確定AI到底能在你的業務裏發揮什麼作用？我們會審計你現有的工作流程，以及任何已經在使用的AI系統，找出幻覺風險、被浪費的預算，以及最值得優先投入的地方。你拿到的是一份<strong>清晰的路線圖，不是一份堆滿流行語的PPT</strong>。",
      "s2.title": "工作流與內容自動化",
      "s2.body": "我們把多步驟的人工流程（分類、翻譯、起草、事實覈查、發佈）變成能在<strong>幾分鐘內跑完，而不是幾小時</strong>的流水線。建立在生產級基礎設施上，不是脆弱的腳本，交接之後依然能長期穩定運行。",
      "s3.title": "生成式AI與知識系統",
      "s3.body": "從讓你的團隊能夠查詢內部文檔、給出有據可查答案的檢索增強系統，到用你品牌語氣說話的輕量微調模型。<strong>生成式AI首先要準確，其次纔是讓人印象深刻。</strong>",
      "s4.title": "Agent系統與集成",
      "s4.body": "<strong>AI不只是會說，還要會做。</strong>通過MCP實現的多智能體系統和工具集成，讓AI能夠查詢你的數據庫、操作你的內部工具，端到端處理多步驟任務，也包括面向免手操作場景的語音助理。",
      "s5.title": "評估、部署與持續支持",
      ...
      "result2.tag": "語音AI",
      "result2.title": "PéiNín Foundation",
      "result2.body": "一款雙語語音陪伴助理，是<strong>最早一批</strong>專門爲美國華裔老年羣體打造的AI陪伴應用之一。",
      "result2.status": "2026年預發佈",
      "result3.tag": "模型微調",
      "result3.title": "品牌語氣模型微調",
      "result3.body": "通用模型只會說通用的話。這一個基於真實編輯寫作內容微調而成，訓練成本只要<strong>0.70美元</strong>，用的是一張消費級顯卡，而不是從零訓練一個定製模型的高昂成本。",
      "teaser.eyebrow": "關於Miloop AI",
      "teaser.statement": "多數AI演示都能跑起來，但很少有AI系統能撐過真實的截止日期、真實的客戶、真實的邊緣案例。Miloop AI做的就是這種能撐住的系統，評估機制從第一天就寫進流水線裏，不是等出問題之後才補上。",
      "teaser.cta.about": "瞭解我們",
      "about.eyebrow": "關於我們",
      "about.lede1": "Miloop AI的標準很簡單：自動化要經得起真實使用的考驗，而不只是在演示裏好看。",
      "about.p1": "Miloop AI設計並交付生產級AI系統，從處理端到端內容流程的多智能體流水線，到檢索增強系統，再到爲特定品牌語氣定製微調的模型。每一套系統都自帶評估層，這一層是寫進流水線本身的，不是事後補上的，所以準確性是被驗證過的，不是被假設的。",
      ...
      "about.founder.p1": "Miloop AI由Yingying Sun創立。她的職業生涯始於一家財富500強科技公司，在那裏她多年負責大型項目管理，並在跨職能團隊之間統一報告規範。這段經歷塑造了她對系統要經得起規模考驗、而不只是在演示裏好看這件事的理解。",
      "about.founder.p2": "這個基礎延伸到了她的AI工程工作中。她自動化過高風險的編輯流程，包括翻譯、事實覈查和排版，也爲雙語老年用戶構建過多模態語音AI系統，在那裏，可靠性不是錦上添花，而是核心目標本身。",
