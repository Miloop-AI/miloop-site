...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hero.offer1.name": "Content engines that catch their own errors",
      "hero.offer1.desc": "Workflows that research, write, and check every claim against its source before you hit publish.",
      "hero.offer2.name": "Reliable voice and chat assistants",
      "hero.offer2.desc": "Multi-modal AI that handles complex customer conversations inside the rules you set.",
      "hero.offer3.name": "Knowledge and data automation",
      "hero.offer3.desc": "Pipelines that turn hours of meetings, video, or raw data into structured reports and automated alerts.",
    ...
    "zh-Hans": {
      ...
      "hero.sub": "人工作业耗费的是时间，无法信任的 AI 耗费的是金钱。我们搭建具备自我验证能力的 AI 系统，自动化您最主要的作业瓶颈，包括：",
      "hero.offer1.name": "能查出自身错误的内容产出流程",
      "hero.offer1.desc": "自动收集资料、撰写初稿，并在发布前逐一比对每项陈述与其来源。",
      "hero.offer2.name": "可靠的语音与对话助理",
      "hero.offer2.desc": "多模态 AI 在您设定的规则范围内，处理复杂的客户对话。",
      "hero.offer3.name": "知识与数据自动化",
      "hero.offer3.desc": "将数小时的会议、视频或原始数据，转为结构化报告与主动送达的通知。",
    ...
    "zh-Hant": {
      ...
      "hero.sub": "人工作業耗費的是時間，無法信任的 AI 耗費的是金錢。我們建置具備自我驗證能力的 AI 系統，自動化您最主要的作業瓶頸，包括：",
      "hero.offer1.name": "能查出自身錯誤的內容產出流程",
      "hero.offer1.desc": "自動蒐集資料、撰寫初稿，並在發布前逐一比對每項陳述與其來源。",
      "hero.offer2.name": "可靠的語音與對話助理",
      "hero.offer2.desc": "多模態 AI 在您設定的規則範圍內，處理複雜的客戶對話。",
      "hero.offer3.name": "知識與資料自動化",
      "hero.offer3.desc": "將數小時的會議、影片或原始資料，轉為結構化報告與主動送達的通知。",
