...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "about.founder.p2": "She has since built AI for work where being wrong is expensive. She has automated editorial workflows, including translation, fact-checking and formatting, and built multi-modal voice AI systems for elderly, bilingual users, where reliability was the primary design constraint.",
      "about.founder.p3": "She holds a Master of Applied Data Science from the University of Michigan, and her background before that spans film and TV directing, video production, programming and news editing. Those jobs are all hard in the same way. Whatever you make, someone has to be able to trust it.",
    ...
    "zh-Hans": {
      ...
      "about.founder.p1": "Miloop AI 由一位 AI 工程师创立。她的职涯是从一家财富500强科技公司起步的，做了多年大型项目管理，把跨职能团队之间的报告口径统一了起来。一套系统撑不撑得住规模，她是在那几年里学会怎么看的。",
      "about.founder.p2": "后来她做的 AI，都用在出错代价很高的地方。她把编辑流程自动化过，翻译、查证、排版都在内；也为双语的老年用户做过多模态语音 AI 系统，那种场合里，可靠性是最优先的设计前提。",
      "about.founder.p3": "她拥有密歇根大学应用数据科学硕士学位，在那之前的背景横跨影视导演、媒体制作、编程与新闻编辑。这些工作难的地方都一样。做出来的东西，别人要信得过才行。",
      "about.founder.aside": "（对，Miloop 这个名字来自她养的猫，公司的首席精神支持官。）",
      "about.founder.channel": "我们也有个 YouTube 频道，由这位猫主持人负责戳 AI 工具，戳到有东西坏掉为止。<a href=\"https://www.youtube.com/channel/UCPrsvNKxjenRt8NLZQLx50Q\" target=\"_blank\" rel=\"noopener\">前往 YouTube 观看</a>。",
    ...
    "zh-Hant": {
      ...
      "about.founder.p1": "Miloop AI 由一位 AI 工程師創立。她的職涯是從一家財富500強科技公司起步的，做了多年大型專案管理，把跨職能團隊之間的報告口徑統一了起來。一套系統撐不撐得住規模，她是在那幾年裡學會怎麼看的。",
      "about.founder.p2": "後來她做的 AI，都用在出錯代價很高的地方。她把編輯流程自動化過，翻譯、查證、排版都在內；也為雙語的年長使用者做過多模態語音 AI 系統，那種場合裡，可靠性是最優先的設計前提。",
      "about.founder.p3": "她擁有密西根大學應用資料科學碩士學位，在那之前的背景橫跨影視導演、媒體製作、程式設計與新聞編輯。這些工作難的地方都一樣。做出來的東西，別人要信得過才行。",
      "about.founder.aside": "（對，Miloop 這個名字來自她養的貓，公司的首席精神支持官。）",
      "about.founder.channel": "我們也有個 YouTube 頻道，由這位貓主持人負責戳 AI 工具，戳到有東西壞掉為止。<a href=\"https://www.youtube.com/channel/UCPrsvNKxjenRt8NLZQLx50Q\" target=\"_blank\" rel=\"noopener\">前往 YouTube 觀看</a>。",
