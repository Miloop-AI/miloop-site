...
(function () {
  ...
  var dict = {
    "en": {
      ...
      "hp.s1": "The system was in daily use and had never given anyone trouble.",
      "hp.r1": "One check turned up 16 of these",
      "hp.s2": "One article, from research to publication, with nobody in the middle.",
      "hp.r2": "This draft never went out",
      "hp.s3": "Company rules on this are split between HR and IT.",
      "hp.r3": "It answered the HR question, then went and read the IT one",
      "hp.s4": "An employee said: put me in for three days off.",
      "hp.r4": "It stopped here. It gets permission only after you say yes",
      "hp.s5": "This number was going into our own evaluation report.",
    ...
    "zh-Hans": {
      ...
      "hp.s1": "这套系统天天在用，也没出过事。",
      "hp.r1": "一次盘查，查出 16 件",
      "hp.s2": "一篇稿子，从找数据到发布，中间没有人。",
      "hp.r2": "这一版没有发出去",
      "hp.s3": "公司规定分在 HR 和 IT 两边。",
      "hp.r3": "它答完 HR 那份，又去翻了 IT 那份",
      "hp.s4": "员工说：帮我请三天假。",
      "hp.r4": "它停在这里，等人点头才拿得到权限",
      "hp.s5": "这个数字本来要放进我们自己的评估报告。",
    ...
    "zh-Hant": {
      ...
      "hp.s1": "這套系統天天在用，也沒出過事。",
      "hp.r1": "一次盤查，查出 16 件",
      "hp.s2": "一篇稿子，從找資料到發佈，中間沒有人。",
      "hp.r2": "這一版沒有發出去",
      "hp.s3": "公司規定分在 HR 和 IT 兩邊。",
      "hp.r3": "它答完 HR 那份，又去翻了 IT 那份",
      "hp.s4": "員工說：幫我請三天假。",
      "hp.r4": "它停在這裡，等人點頭才拿得到權限",
      "hp.s5": "這個數字本來要放進我們自己的評估報告。",
