...
const COPY = {
  ...
  "zh-Hans": {
    ...
    languageHelp: "没有找到您需要的选项？欢迎随时发邮件至 info@miloop.ai。",
    continue: "继续",
    back: "上一步",
    submit: "提交",
    sending: "发送中…",
    ...
    questions: {
      ...
      problemType: {
        title: "您需要哪方面的帮助？",
        options: [
          { value: "assessment", label: "AI 就绪度评估" },
          { value: "automation", label: "工作流与内容自动化" },
          { value: "generative", label: "生成式 AI 与知识系统" },
          { value: "agentic", label: "Agent 系统与集成" },
    ...
    confirmation: {
      title: "感谢您，我们已收到所有信息。",
      subtitle: "我们会尽快查看，并在1至2个工作日内与您联系。若有本次对话未涵盖的事项，您可以通过 info@miloop.ai 与我们联系。",
    },
    exitConfirm: {
    ...
    error: "出现问题，请重试，或直接发送邮件至 info@miloop.ai。",
  },
  ...
  "zh-Hant": {
    ...
    languageHelp: "沒有找到您需要的選項？歡迎隨時寄信至 info@miloop.ai。",
    continue: "繼續",
    back: "上一步",
    submit: "送出",
    sending: "傳送中…",
    ...
    questions: {
      ...
      problemType: {
        title: "您需要哪方面的協助？",
        options: [
          { value: "assessment", label: "AI 就緒度評估" },
          { value: "automation", label: "工作流與內容自動化" },
          { value: "generative", label: "生成式 AI 與知識系統" },
          { value: "agentic", label: "Agent 系統與整合" },
          { value: "evaluation", label: "評估、部署與持續支援" },
        ],
        assistant: {
    ...
    confirmation: {
      title: "謝謝您，我們已收到所有資訊。",
      subtitle: "我們會盡快確認，並在1至2個工作日內與您聯繫。若有本次對話未涵蓋的事項，您可以透過 info@miloop.ai 與我們聯繫。",
    },
    exitConfirm: {
    ...
    error: "發生問題，請重試，或直接寄送郵件至 info@miloop.ai。",
  },
};
