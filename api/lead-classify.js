// Per-instance request throttle, same shape as the one in lead-intake.js.
// See CLAUDE.local.md before relying on it.
...
const FORCED_CLOSE_MESSAGE = {
  ...
  "zh-Hans": "您的需求我们记下了，谢谢说明。",
  "zh-Hant": "您的需求我們記下了，謝謝說明。",
};
...
export default async function handler(req, res) {
  ...
  // Turn cap, evaluated here rather than trusting the client's count or the
...
// Claude's extended thinking is opt-in, off by default. No "thinking" field
// is set below, so no reasoning tokens are spent and the full max_tokens
// budget goes toward the visible reply.
